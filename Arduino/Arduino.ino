...
static byte *keystore(byte key)
{
  ...
  case 0:
  {
    return new byte[16]{0x5C, 0x52, 0xD9, 0x1C, 0xF3, 0x82, 0xAC, 0xA4, 0x89, 0xD8, 0x81, 0x78, 0xEC, 0x16, 0x29, 0x7B};
  }
  break;
  case 1:
  {
    return new byte[16]{0x9D, 0x4F, 0x50, 0xFC, 0xE1, 0xB6, 0x8E, 0x12, 0x09, 0x30, 0x7D, 0xDB, 0xA6, 0xA5, 0xB5, 0xAA};
  }
  break;
  case 2:
  {
    return new byte[16]{0x09, 0x75, 0x98, 0x88, 0x64, 0xAC, 0xF7, 0x62, 0x1B, 0xC0, 0x90, 0x9D, 0xF0, 0xFC, 0xAB, 0xFF};
  }
  break;
  case 3:
  {
    return new byte[16]{0xC9, 0x11, 0x5C, 0xE2, 0x06, 0x4A, 0x26, 0x86, 0xD8, 0xD6, 0xD9, 0xD0, 0x8C, 0xDE, 0x30, 0x59};
  }
  break;
  case 4:
  {
    return new byte[16]{0x66, 0x75, 0x39, 0xD2, 0xFB, 0x42, 0x73, 0xB2, 0x90, 0x3F, 0xD7, 0xA3, 0x9E, 0xD2, 0xC6, 0x0C};
  }
  break;
  case 5:
  {
    return new byte[16]{0xF4, 0xFA, 0xEF, 0x20, 0xF4, 0xDB, 0xAB, 0x31, 0xD1, 0x86, 0x74, 0xFD, 0x8F, 0x99, 0x05, 0x66};
  }
  break;
  case 6:
  {
    return new byte[16]{0xEA, 0x0C, 0x81, 0x13, 0x63, 0xD7, 0xE9, 0x30, 0xF9, 0x61, 0x13, 0x5A, 0x4F, 0x35, 0x2D, 0xDC};
  }
  break;
  case 8:
  {
    return new byte[16]{0x0A, 0x2E, 0x73, 0x30, 0x5C, 0x38, 0x2D, 0x4F, 0x31, 0x0D, 0x0A, 0xED, 0x84, 0xA4, 0x18, 0x00};
  }
  break;
  case 0xA:
  {
    return new byte[16]{0xAC, 0x00, 0xC0, 0xE3, 0xE8, 0x0A, 0xF0, 0x68, 0x3F, 0xDD, 0x17, 0x45, 0x19, 0x45, 0x43, 0xBD};
  }
  break;
  case 0xB3:
  {
    return new byte[16]{0x03, 0xBE, 0xB6, 0x54, 0x99, 0x14, 0x04, 0x83, 0xBA, 0x18, 0x7A, 0x64, 0xEF, 0x90, 0x26, 0x1D};
  }
  break;
  case 0xD:
  {
    return new byte[16]{0xDF, 0xF3, 0xFC, 0xD6, 0x08, 0xB0, 0x55, 0x97, 0xCF, 0x09, 0xA2, 0x3B, 0xD1, 0x7D, 0x3F, 0xD2};
  }
  break;
  case 0xD9:
  {
    return new byte[16]{0xC7, 0xAC, 0x13, 0x06, 0xDE, 0xFE, 0x39, 0xEC, 0x83, 0xA1, 0x48, 0x3B, 0x0E, 0xE2, 0xEC, 0x89};
  }
  break;
  case 0xEB:
  {
    return new byte[16]{0x41, 0x84, 0x99, 0xBE, 0x9D, 0x35, 0xA3, 0xB9, 0xFC, 0x6A, 0xD0, 0xD6, 0xF0, 0x41, 0xBB, 0x26};
  }
  break;
  case 0x2F:
  {
    return new byte[16]{0x4A, 0xA7, 0xC7, 0xB0, 0x11, 0x34, 0x46, 0x6F, 0xAC, 0x82, 0x16, 0x3E, 0x4B, 0xB5, 0x1B, 0xF9};
  }
  break;
  default:
  {
    return new byte[16]{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
  }
  break; // не найдено
  }
};
...
static byte *challenge1_secret(byte version)
{
  ...
  case 0:
  {
    return new byte[8]{0xD2, 0x07, 0x22, 0x53, 0xA4, 0xF2, 0x74, 0x68};
  }
  break;
  case 1:
  {
    return new byte[8]{0xF5, 0xD7, 0xD4, 0xB5, 0x75, 0xF0, 0x8E, 0x4E};
  }
  break;
  case 2:
  {
    return new byte[8]{0xB3, 0x7A, 0x16, 0xEF, 0x55, 0x7B, 0xD0, 0x89};
  }
  break;
  case 3:
  {
    return new byte[8]{0xCC, 0x69, 0x95, 0x81, 0xFD, 0x89, 0x12, 0x6C};
  }
  break;
  case 4:
  {
    return new byte[8]{0xA0, 0x4E, 0x32, 0xBB, 0xA7, 0x13, 0x9E, 0x46};
  }
  break;
  case 5:
  {
    return new byte[8]{0x49, 0x5E, 0x03, 0x47, 0x94, 0x93, 0x1D, 0x7B};
  }
  break;
  case 6:
  {
    return new byte[8]{0xB0, 0xB8, 0x09, 0x83, 0x39, 0x89, 0xFA, 0xE2};
  }
  break;
  case 8:
  {
    return new byte[8]{0xAD, 0x40, 0x43, 0x82, 0x56, 0xEB, 0x45, 0x8B};
  }
  break;
  case 0xA:
  {
    return new byte[8]{0xC2, 0x37, 0x7E, 0x8A, 0x74, 0x09, 0x6C, 0x5F};
  }
  break;
  case 0xD:
  {
    return new byte[8]{0x58, 0x1C, 0x7F, 0x19, 0x44, 0xF9, 0x62, 0x62};
  }
  break;
  case 0x2F:
  {
    return new byte[8]{0xC9, 0xF8, 0x09, 0x45, 0x2A, 0xA2, 0xBE, 0xD5};
  }
  break;
  case 0xD9:
  {
    return new byte[8]{0x90, 0xE1, 0xF0, 0xC0, 0x01, 0x78, 0xE3, 0xFF};
  }
  break;
  case 0x97:
  {
    return new byte[8]{0x66, 0x1A, 0x4D, 0x7F, 0x6E, 0xCD, 0x33, 0xC5};
  }
  break;
  case 0xEB:
  {
    return new byte[8]{0x0B, 0xD9, 0x02, 0x7E, 0x85, 0x1F, 0xA1, 0x23};
  }
  break;
  case 0xB3:
  {
    return new byte[8]{0xD8, 0xD3, 0xAE, 0xA4, 0xD8, 0x04, 0x64, 0x10};
  }
  break;
  default:
  {
...
static byte *challenge2_secret(byte version)
{
  ...
  case 0:
  {
    return new byte[8]{0xF4, 0xE0, 0x43, 0x13, 0xAD, 0x2E, 0xB4, 0xDB};
  }
  break;
  case 1:
  {
    return new byte[8]{0xFE, 0x7D, 0x78, 0x99, 0xBF, 0xEC, 0x47, 0xC5};
  }
  break;
  case 2:
  {
    return new byte[8]{0x86, 0x5E, 0x3E, 0xEF, 0x9D, 0xFB, 0xB1, 0xFD};
  }
  break;
  case 3:
  {
    return new byte[8]{0x30, 0x6F, 0x3A, 0x03, 0xD8, 0x6C, 0xBE, 0xE4};
  }
  break;
  case 4:
  {
    return new byte[8]{0xFF, 0x72, 0xBD, 0x2B, 0x83, 0xB8, 0x9D, 0x2F};
  }
  break;
  case 5:
  {
    return new byte[8]{0x84, 0x22, 0xDF, 0xEA, 0xE2, 0x1B, 0x63, 0xC2};
  }
  break;
  case 6:
  {
    return new byte[8]{0x58, 0xB9, 0x5A, 0xAE, 0xF3, 0x99, 0xDB, 0xD0};
  }
  break;
  case 0xA:
  {
    return new byte[8]{0x09, 0x3E, 0xC5, 0x19, 0xAF, 0x0F, 0x50, 0x2D};
  }
  break;
  case 0xD:
  {
    return new byte[8]{0x31, 0x80, 0x53, 0x87, 0x5C, 0x20, 0x3E, 0x24};
  }
  break;
  case 0x2F:
  {
    return new byte[8]{0x1B, 0xDF, 0x24, 0x33, 0xEB, 0x29, 0x15, 0x5B};
  }
  break;
  case 0xD9:
  {
    return new byte[8]{0xC3, 0x4A, 0x6A, 0x7B, 0x20, 0x5F, 0xE8, 0xF9};
  }
  break;
  case 0x97:
  {
    return new byte[8]{0x2B, 0xF5, 0xF2, 0x95, 0x86, 0xA7, 0x64, 0x48};
  }
  break;
  case 0xEB:
  {
    return new byte[8]{0xF7, 0x91, 0xED, 0x0B, 0x3F, 0x49, 0xA4, 0x48};
  }
  break;
  case 0xB3:
  {
    return new byte[8]{0xE3, 0x2B, 0x8F, 0x56, 0xB2, 0x64, 0x12, 0x98};
  }
  break;
  default:
  {
  ...
  while (true)
  {
    if (pspSerial.available() > 0)
    {
      ...
      if (pspdata[0] == 0x5A)
      {
        ...
        case 0x81:
        {
          //byte header1[3] = {0xA5, 0x0A, 0x06}; // Было
          byte header1[3] = {0xA5, 0x12, 0x06}; // Стало
          byte temp1[11] = {0};
          byte cs1[1] = {0};
